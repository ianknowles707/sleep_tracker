...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //Get the value passed from the SleepTrackerFragment in Safe Args
        ...
        val sleepQualityViewModel=ViewModelProvider(this,
        viewModelFactory).get(SleepQualityViewModel::class.java)

        binding.sleepQualityViewModel=sleepQualityViewModel

        //Observe the navigation variable (simple Boolean) to see when to action the
        //navigation back to the tracking Fragment
